...
typedef enum{
    ...
    ZoomSDKShareStatus_Begin,
    ZoomSDKShareStatus_End,
}ZoomSDKShareStatus;
...
typedef enum{
    ...
    //you can request other screen remote control right
    ZoomSDKRemoteControlStatus_CanRequest,
    //other decline the remote control request
    ZoomSDKRemoteControlStatus_Decline,
    //other accept the remote control request
    ZoomSDKRemoteControlStatus_Accept,
    //you give up the remote control right of other's screen
    ZoomSDKRemoteControlStatus_GiveUp,
    //you receive the remote control request
    ZoomSDKRemoteControlStatus_Request,
