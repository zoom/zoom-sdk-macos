...
- (void)drawRect:(NSRect)dirtyRect {
    ...
    if(self.title)
    {
        ...
        NSTextStorage* textStorage = [[[NSTextStorage alloc] initWithString:self.title] autorelease];
        ...
        NSTextContainer *textContainer = [[[NSTextContainer alloc] initWithContainerSize:NSMakeSize(self.bounds.size.width, y_offset)] autorelease];
...
- (int)getTitleWidth
{
    ...
    if(self.title)
    {
        ...
        NSTextContainer *textContainer = [[[NSTextContainer alloc] initWithContainerSize:NSMakeSize(360, self.bounds.size.height)] autorelease];
        [textContainer setLineFragmentPadding:0.0f];
        NSLayoutManager *layoutManager = [[[NSLayoutManager alloc] init] autorelease];
        [layoutManager addTextContainer:textContainer];
        [textStorage addLayoutManager:layoutManager];
