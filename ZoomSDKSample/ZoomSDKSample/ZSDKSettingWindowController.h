...
@interface ZSDKSettingWindowController : NSWindowController<NSTabViewDelegate, ZoomSDKSettingTestAudioDelegate, ZoomSDKSettingVideoDelegate, ZoomSDKSettingAudioDeviceDelegate>
{
