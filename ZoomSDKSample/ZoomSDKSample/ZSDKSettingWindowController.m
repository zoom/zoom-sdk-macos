...
@interface ZSDKSettingWindowController ()
...
@implementation ZSDKSettingWindowController
...
- (id)init
{
    self = [super initWithWindowNibName:@"ZSDKSettingWindowController" owner:self];
    if(self)
    {
